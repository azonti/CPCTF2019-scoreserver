<template>
  <div>
    <div v-if="user.id">
      <vue-headful :title="`${user.name} | CPCTF2019`" />
      <h1>{{ user.name }}</h1>
      <div class="row">
        <div class="col-md-4">
            ...
            <dl class="row">
              ...
              <dd class="col-xs-8">
                <ul class="list-unstyled">
                  <li class="solved-chals" v-for="_solved in solved"><router-link :to="{ name: 'challenge', params: { id: _solved.challenge_id } }" :class="'chal-name-' + _solved.genre">{{ _solved.name }}</router-link></li>
                </ul>
              </dd>
            </dl>
          </div>
